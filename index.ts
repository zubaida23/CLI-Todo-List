...
console.log(chalk.bold.rgb(204, 204, 204)(`<<<==========>>>  ${chalk.italic.magenta('Welcome To \'CodeWithZubayda\' - Updated Todo-List App')}  <<<===========>>>`));
console.log(chalk.bold.rgb(204, 204, 204)(`\t\t <<<=============================================>>>\n`));
...
let viewTasks = () => {
    console.log(chalk.cyanBright.bold("Your Todo-List: "));
